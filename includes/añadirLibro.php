        <section class="contenedor__añadir">
            ...
            <form action="includes/procesarAñadirLibro.php" method="POST" enctype="multipart/form-data" id="formularioAñadir">
                <input type="hidden" name="isbnOriginal" id="isbnOriginal" value="">
                <label for="titulo">Título del libro</label>
                <input type="text" id="titulo" name="titulo" placeholder="Introduzca el título" required>

                <label for="autor">Autor del libro</label>
                <input type="text" id="autor" name="autor" placeholder="Introduzca el autor" required>

                <label for="genero">Género del libro</label>
                <input type="text" id="genero" name="genero" placeholder="Introduzca el género" required>

                <label for="año">Año de publicación</label>
                <input type="number" id="año" name="año" placeholder="Introduzca el año de publicación" required>
        
                <label for="paginas">Número de páginas</label>
                <input type="number" id="paginas" name="paginas" placeholder="Introduzca el número de páginas" required>

                <label for="ISBN">ISBN</label>
                <input type="text" id="ISBN" name="ISBN" placeholder="Introduzca el ISBN" required>

                <label>Portada del libro</label>
                <div class="portada-upload-container">
                    <input type="file" id="portada" name="portada" accept="image/*" class="oculto-file">
